...
setenv earlycon "off"
# Serial console - can be overridden in armbianEnv.txt (e.g., ttyFIQ0,115200 for fiq-debugger boards)
setenv serialconsole "ttyS0,1500000"
...
if test "${console}" = "serial" || test "${console}" = "both"; then setenv consoleargs "console=${serialconsole} ${consoleargs}"; fi
